    ...
    <>
      ...
      >
        <MenuItem onClick={onNewEmptyFileClick}>
          ...
          <Typography variant="inherit">{t("file.newEmptyFile")}</Typography>
        </MenuItem>
        ...
        <MenuItem onClick={onSaveFileClick} disabled={!isFileOpen}>
          ...
          <Typography variant="inherit">{t("file.saveFile")}</Typography>
        </MenuItem>
        ...
        <MenuItem onClick={onDownloadFileClick} disabled={!isFileOpen}>
          ...
          <Typography variant="inherit">{t("file.downloadFile")}</Typography>
        </MenuItem>
        <MenuItem disabled={true}>
          <ListItemIcon>
            <InfoIcon />
          </ListItemIcon>
          <Typography variant="inherit">{t("file.details")}</Typography>
        </MenuItem>
        <MenuItem onClick={onChangeLanguageClick}>
          <ListItemIcon>
            <LanguageIcon />
          </ListItemIcon>
          <Typography variant="inherit">{t("file.language")}</Typography>
        </MenuItem>
        ...
        <MenuItem onClick={onCloseFileClick} disabled={!isFileOpen}>
          ...
          <Typography variant="inherit">{t("file.closeFile")}</Typography>
        </MenuItem>
      </Menu>
    </>
  );
